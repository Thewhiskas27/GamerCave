...
public class GameTests
{
    ...
    [Test]
    public void XPlayerGoesFirst() { Assert.That(game.CurrentPlayer, Is.EqualTo("X")); }
    ...
    [Test]
    public void NewGameIsNotOver() { Assert.That(game.IsOver(), Is.False); }
    ...
    [Test]
    public void ValidMovesAreAllowed() { Assert.That(game.IsAllowedMove("1")); }
    ...
    [Test]
    public void NewGameIsNotADraw() { Assert.That(game.IsDraw(), Is.False); }
